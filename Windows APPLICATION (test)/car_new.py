...
def start_processing():
	...
	try:
		...
		print_voice_code = str(voice_text)+"	"+str(predicted_code)
		ui.label_2.setText(str(print_voice_code))
		time.sleep(1)
		ui.pushButton.setText("Press \n to \n Speak")
		bluetooth_arduino_send.send_data(predicted_code)
